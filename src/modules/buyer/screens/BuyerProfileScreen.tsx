...
export default function BuyerProfileScreen({ navigation }: any) {
  ...
  const [profile, setProfile] = useState<BuyerProfile>({
    name: user?.name || 'Buyer User',
    email: user?.email || 'buyer@example.com',
    phone: '+1 234 567 8900',
    location: 'San Francisco, CA',
    bio: 'Enthusiastic buyer looking for great deals!',
    verified: true,
    rating: 4.8,
    reviewCount: 24,
    totalPurchases: 42,
    ...
    return (
      ...
      >
        <SafeAreaView style={styles.centerContainer}>
          ...
          <Text style={styles.noticeText}>Only buyers can view this profile.</Text>
        </SafeAreaView>
      </LinearGradient>
    );
  }
          ...
          <View style={styles.section}>
            ...
            <View style={styles.statsGrid}>
              <View style={styles.statBox}>
                <Text style={styles.statValue}>{profile.totalPurchases}</Text>
                <Text style={styles.statLabel}>Total Orders</Text>
              </View>
              <View style={styles.statBox}>
                <Text style={styles.statValue}>${profile.totalSpent}</Text>
          ...
          <View style={styles.section}>
            ...
            >
              ...
              <View style={styles.settingContent}>
                ...
                <Text style={styles.settingSubtitle}>View your purchases</Text>
              </View>
            ...
            >
              ...
              <View style={styles.settingContent}>
                ...
                <Text style={styles.settingSubtitle}>Your wishlisted items</Text>
              </View>
              <Ionicons name="chevron-forward" size={20} color={COLORS.subtle} />
            </TouchableOpacity>
            ...
            >
              ...
              <View style={styles.settingContent}>
                ...
                <Text style={styles.settingSubtitle}>Chat with sellers</Text>
              </View>
              <Ionicons name="chevron-forward" size={20} color={COLORS.subtle} />
            </TouchableOpacity>
          </View>
